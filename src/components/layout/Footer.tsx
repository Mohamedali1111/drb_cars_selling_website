// Footer provides navigation links, action buttons, and social media links with premium dark theme.
"use client";

const navigationColumns = [
  {
    title: "Mobile app",
    links: ["Features", "Live show", "Video record"],
  },
  {
    title: "Community",
    links: ["Featured artists", "The Portal", "Live events"],
  },
  {
    title: "Company",
    links: ["About us", "Contact us", "History"],
  },
];
